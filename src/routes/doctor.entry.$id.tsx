    ...
    fields: [
      ...
      { key: "weight", label: "体重", type: "number", unit: "kg", source: "auto", ref: "24–40", min: 24, max: 40 },
      {
        ...
        crit: {
          ...
          timeLimit: "24 小时内",
          plan: [
            "体检医生现场复测身高体重并确认无录入错误",
            "体检医生加测腰围/血压并确认合并症询问完成",
            "体检医生确认已开具内分泌/儿保门诊转诊建议",
          ],
        },
      },
    ],
    ...
    fields: [
      {
        ...
        crit: {
          ...
          timeLimit: "30 分钟内",
          plan: [
            "体检医生休息 5 分钟后换臂复测并确认读数",
            "体检医生完成症状评估（头痛/视物模糊/心悸）",
            "体检医生确认已通知家长并开具心内科绿色通道转诊",
          ],
        },
      },
    ...
    fields: [
      {
        ...
        crit: {
          ...
          timeLimit: "15 分钟内",
          plan: [
            "体检医生复核血糖并确认空腹状态（≥8 小时）",
            "体检医生完成对症处置与症状询问并确认",
            "体检医生确认已通知家长并完成内分泌科转诊",
          ],
        },
      },
      {
